...
author: "2160032_Park_Manjun"
date: "2017<eb>ÖÑ 3<ec>õî 22<ec>ùº"
output:
...
modelRf <- train(classe ~ ., data=trainData, method="rf", trControl=controlRf, ntree=250, na.action = na.omit)
```
